...
export const AuthNavigator: VFC = () => {
	return (
		<AuthStack.Navigator initialRouteName="Signin" screenOptions={{ headerShown: false }}>
			...
			<AuthStack.Screen name="ShopInfoRegister" component={ShopInfoRegisterScreen} options={() => ({})} />
			<AuthStack.Screen name="ShopInfoVerification" component={ShopInfoVerificationScreen} options={() => ({})} />
		</AuthStack.Navigator>
	);
};
